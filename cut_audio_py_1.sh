...
format_code=/home/vbee/cut_data/huydd/py-webrtcvad/format_audio.py
python $format_code --audio_dir=$audio_path --save_dir=$audio_path 
# Cut audio by py-webrtc vad 
py_path=/home/vbee/huydd/cut_data/py-webrtcvad/example1.py

python $py_path 3 $file_path $save_dir 

# Cut audio output by silero vad by speech denoise 
silence_detection_path=/home/vbee/huydd/cut_data/Speech-Denoise/model_1_silent_interval_detection/audioonly_model/inference_1.py
ckpt=15
